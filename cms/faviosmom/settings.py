...
SECRET_KEY = 'iv=cgkyu1k92_4%9r#s@e&(97%9u)o()1&rjo^q=6&*u7keo7='
...
ROOT_URLCONF = 'faviosmom.urls'



WSGI_APPLICATION = 'faviosmom.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'faviosmom', 'static'),
)
SITE_ID = 1
